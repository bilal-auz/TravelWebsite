                    ...
                    <div class="col1_1" >
                        <div class="blured" style="background-image: url({{ asset('/images/pattern1.svg') }});">
                            <div class="slider hotels">
                                <h3>Hotels</h3>
                                @if (!array_key_exists("errors",$city->hotels) && false)
                ...
                <div class="cols col2">
                    <div class="col2_1">
                        <div class="container place">
                            <div class="p1">
                              <div class="p1-img"><img src="{{ $city->image->results[0]->urls->thumb }}" alt=""></div>
                              <div class="p1-name"><p>{{ $city->image->results[0]->description }}</p></div>
                            </div>
                            <div class="p2"><p>{{ $city->image->results[0]->alt_description }}</p>
                            </div>
                          </div>
                    </div>
                    <div class="col2_2">
                                        ...
                                        <div class="data">
                                            <div class="dataInfo">
                                                <div class=" dataCol col1">
                                                    <div>
                                                        <p class="fix">from:</p>
                                                        <p class="var">{{ $city->flights->data[0]->itineraries[0]->segments[0]->departure->iataCode }}</p>
                                                    </div>
                                                    <div>
                                                        <p class="fix">class:</p>
                                                        <p class="var">{{ $city->flights->data[0]->travelerPricings[0]->fareDetailsBySegment[0]->cabin }}</p>
                                                    </div>
                                                </div>
                                                <div class="dataCol col2">
                                                    ...
                                                    <div>
                                                        <p class="fix">date:</p>
                                                        <p class="var">{{ $city->flights->data[0]->lastTicketingDate }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="dataPrice">
                                                <div>
                                                    <p class="fix">price:</p>
                                                    <p class="var">{{ $city->flights->data[0]->price->total }} {{ $city->flights->data[0]->price->currency }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    @else
                                            ...
                                            <div class="new_comment">
                                                ...
                                                <ul class="user_comment">
                                                    ...
                                                    <div class="comment_body">
                                                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. In amet temporibus iste, voluptates quos adipisci suscipit odit tempora vero animi deleniti impedit, quibusdam tenetur exercitationem voluptatibus ipsa. Fuga, animi molestiae!</p>
                                                    </div>
                                                    <div class="comment_toolbar">
                                                        ...
                                                        <div class="comment_details">
                                                            ...
                                                            <li><i class="fa fa-calendar"></i>04/05/2015</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <!-- comments toolbar -->
